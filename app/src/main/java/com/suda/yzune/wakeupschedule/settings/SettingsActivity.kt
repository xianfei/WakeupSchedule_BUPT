...
class SettingsActivity : BaseListActivity() {
    ...
    private fun onItemsCreated(items: MutableList<BaseSettingItem>) {
        ...
        items.add(SwitchItem("自动检查更新", getPrefer().getBoolean(Const.KEY_CHECK_UPDATE, false)))
        ...
        items.add(SwitchItem("显示侧栏「苏大生活」", getPrefer().getBoolean(Const.KEY_SHOW_SUDA_LIFE, false)))
