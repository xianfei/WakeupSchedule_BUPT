...
class SettingsActivity : BaseListActivity() {
    ...
    private fun onItemsCreated(items: MutableList<BaseSettingItem>) {
        ...
        items.add(SwitchItem("自动检查更新", getPrefer().getBoolean(PreferenceKeys.CHECK_UPDATE, false)))
        ...
        items.add(SwitchItem("显示侧栏「苏大生活」", getPrefer().getBoolean(PreferenceKeys.SHOW_SUDA_LIFE, false)))
