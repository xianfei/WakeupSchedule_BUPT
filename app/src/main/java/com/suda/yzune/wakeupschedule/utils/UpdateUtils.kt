            ...
            try {
                ...
                if (!context.getPrefer().getBoolean("isInitTimeTable", false)) {
                    val timeList = ArrayList<TimeDetailBean>().apply {
                        ...
                        add(TimeDetailBean(5, "11:30", "12:15", 1))
                        add(TimeDetailBean(6, "13:00", "13:45", 1))
                        add(TimeDetailBean(7, "13:50", "14:35", 1))
                        add(TimeDetailBean(8, "14:45", "15:30", 1))
                        add(TimeDetailBean(9, "15:40", "16:25", 1))
                        add(TimeDetailBean(10, "16:35", "17:20", 1))
                        add(TimeDetailBean(11, "17:25", "18:10", 1))
                        add(TimeDetailBean(12, "18:30", "19:15", 1))
                        add(TimeDetailBean(13, "19:20", "20:05", 1))
                        add(TimeDetailBean(14, "20:10", "20:55", 1))
